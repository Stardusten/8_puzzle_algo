...
// Use bit operation to encode all the permutations of 123456780 to long integer
// Store an integer range 0(0000)~8(1000) every 4 bits
// So the min_code = 305419896 (represents 0,1,2,3,4,5,6,7,8)
//        max_code = 36344967696 (represents 8,7,6,5,4,3,2,1,0)
long encode(int *p){
    long code=0;
    for(int i=0;i<9;i++){
        code|=((long)p[i]<<(i<<2));
